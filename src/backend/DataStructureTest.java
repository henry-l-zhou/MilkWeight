...
class DataStructureTest {
  ...
  public void test01_size() {
    ...
    if (ds.size() != 4) { fail("Size is incorrect"); }
  }
  ...
  public void test03_getMilkWeightDateRange() {
    ...
    } else if (list.get(1) != mw2) { fail("The list is not sorted correctly"); }
  }
  ...
  public void test04_getMilkWeightMonth() {
    ...
    if (list.get(0) != mw1) {
      ...
      fail("The list is not sorted correctly");
    } else if (list.get(2) != mw4) { fail("The list is not sorted correctyl"); }
  }
